 ...
 * @author bayuirfan
 */
public class ChangePersediaanDialog extends javax.swing.JFrame {

    /**
     * Creates new form ChangePersediaanDialog
     */
    public ChangePersediaanDialog() {
        initComponents();
        titik1Field.setText(String.valueOf(Persediaan.getTitik1()));
        titik2Field.setText(String.valueOf(Persediaan.getTitik2()));
        titik3Field.setText(String.valueOf(Persediaan.getTitik3()));
        this.setDefaultCloseOperation(ChangePersediaanDialog.DISPOSE_ON_CLOSE);
    ...
    private void initComponents() {
        ...
        setTitle("Ganti Batas Persediaan");
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
        ...
        Persediaan.setTitik1(Double.valueOf(titik1Field.getText()));
        Persediaan.setTitik2(Double.valueOf(titik2Field.getText()));
        Persediaan.setTitik3(Double.valueOf(titik3Field.getText()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChangePersediaanDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChangePersediaanDialog().setVisible(true);
            }
        });
    }
